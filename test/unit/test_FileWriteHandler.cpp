...
{
	// Arrange
	EXPECT_CALL(m_fileSystemOps, isExistingFile)
...
{
	// Arrange
	EXPECT_CALL(m_fileSystemOps, writeToFile)
	.WillOnce(testing::Throw(FileSystemOps::FileNotFoundException("File not found")));
